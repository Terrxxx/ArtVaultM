...
> 游戏美术资产管理与版本协作平台 · **v1.0.0（测试版）**  
> 设计与实现：**Claude**（Anthropic）

小型开发团队的美术资产常常散落在网盘、群聊压缩包和本地磁盘里——同一个模型改到第 8 版，谁也说不清哪份是最新，也没人知道上周那张贴图是谁传的。**艺库**把这件事收拢到一处：登录后建项目、把项目和 GitHub 仓库关联、上传资产并自动分好类、同一资产换版本、在线预览、评论协作、下载分发。
